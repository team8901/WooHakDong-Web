...
const InquiryDropdown = ({ selectedCategory, setSelectedCategory }: Readonly<DropdownProps>) => {
  ...
  return (
    <div className="relative inline-block text-left">
      ...
      >
        <Body1
          text={INQUIRY_CATEGORY.find((v) => v.category === selectedCategory)?.content ?? '문의 유형'}
